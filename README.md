...
- 🧩 I enjoy turning ideas into practical software and clean, maintainable code.
- 🔧 I build with **Java / Spring**, and I also explore **Rust** and **Python**.
- 📚 I keep learning through open-source projects, systems practice, and coding fundamentals.
- 📍 Based in China · open to interesting technical conversations.

## Tech stack

<p>
  <img src="https://skillicons.dev/icons?i=java,spring,maven,redis,mysql,python,rust,git,github" alt="Java, Spring, Maven, Redis, MySQL, Python, Rust, Git and GitHub" />
</p>
